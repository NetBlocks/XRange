...
static void SetSysClock(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLMUL |
                                        RCC_CFGR_PLLDIV));
#ifndef XRANGE_HW_VER
#error "Missing define: XRANGE_HW_VER (ie. XR_VER_1_0 or XR_VER_0_1)"
#endif

#if( XRANGE_HW_VER == XR_VER_1_0 )

    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMUL4 | RCC_CFGR_PLLDIV2);//16Mhz
#elif( XRANGE_HW_VER == XR_VER_0_1 )
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMUL8 | RCC_CFGR_PLLDIV2);//8Mhz
#else
#error "Incorrect: XRANGE_HW_VER (ie. XR_VER_1_0 or XR_VER_0_1)"
#endif
    /* Enable PLL */
    RCC->CR |= RCC_CR_PLLON;
