 ...
 */
#define APP_TX_DUTYCYCLE                            2000000 //5000000
...
static void PrepareTxFrame( uint8_t port )
{
    ...
    case 2:
        {
#if defined( USE_BAND_868 )
            uint16_t pressure = 11;
            int16_t altitudeBar = 6;
            int16_t temperature = 45;
            int32_t latitude, longitude = 7;
            uint16_t altitudeGps = 0xFFFF;
            uint8_t batteryLevel = 55;
...
//                LoRaMacCallbacks.GetBatteryLevel = 3;
